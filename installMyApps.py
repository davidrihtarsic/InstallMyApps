...
## LibreOffice #################################################
	...
	LibreOffice.deb_package_path_32 = 'http://mirrors.uniri.hr/tdf/libreoffice/stable/5.3.2/deb/x86/'
	LibreOffice.deb_package_file_32 = 'LibreOffice_5.3.2_Linux_x86_deb.tar.gz'
