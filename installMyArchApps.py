...
# rigofrods ######################################################
rigofrods = NovProgram()
rigofrods.program_name = 'rigofrods'
rigofrods.category = 'Other'
rigofrods.description = 'Game'
rigofrods.arch_yaourt_cmds = ['rigofrods']
rigofrods.notes = ''
rigofrods.auto_install = True
vsi_programi.append(rigofrods)
# PDFtk ######################################################
PDFtk = NovProgram()
...
PanDoc.arch_zsh_cmds = ['sudo npm install --global mermaid-filter --unsafe-perm=true']
PanDoc.notes = ''
...
# NCDU ########################################################
ncdu = NovProgram()
ncdu.program_name = 'ncdu'
ncdu.category = 'System'
ncdu.description = 'Pregled zasedenosti diska po mapah, tako, da prikaže kje imaš največje file...'
ncdu.arch_pacman_cmds = ['ncdu']
ncdu.auto_install = True
vsi_programi.append(ncdu)
# NMAP ########################################################
nmap = NovProgram()
...
FreeFileSync.auto_install = False
...
# KiCAD########################################################
KiCAD = NovProgram()
KiCAD.program_name = 'KiCAD'
KiCAD.category = 'Graphics'
KiCAD.description = 'Orodje za elektrotehnisko risanje.'
KiCAD.arch_yaourt_install = ['kicad']
KiCAD.auto_install = False
vsi_programi.append(KiCAD)
# FREECAD #####################################################
FreeCAD = NovProgram()
...
# Darktable ########################################################
Darktable = NovProgram()
Darktable.program_name = 'Darktable'
Darktable.category = 'Graphics'
Darktable.arch_pacman_cmds = ['darktable']
Darktable.description = "darktable is an open source photography workflow application and raw developer. A virtual lighttable and darkroom for photographers. It manages your digital negatives in a database, lets you view them through a zoomable lighttable and enables you to develop raw images and enhance them."
Darktable.auto_install = False
vsi_programi.append(Darktable)
# LibreOffice #################################################
...
Mendelay.description = """Academic software for managing and sharing research \
    papers (desktop client)."""
...
SublimeText3.arch_yaourt_cmds = [
    'sublime-text-dev',
    'panzer-git']
SublimeText3.description = "Notepad on steroids..."
SublimeText3.auto_install = False
vsi_programi.append(SublimeText3)
# Atom ##################################################
Atom = NovProgram()
Atom.program_name = 'Atom'
Atom.category = 'Office'
Atom.arch_pacman_cmds = ['hunspell']
Atom.arch_yaourt_cmds = [
    'atom-editor-bin',
    'hunspell-sl']
Atom.arch_zsh_cmds = [
...
Atom.description = "Notepad on steroids..."
...
# SucklessTerminal ##################################################
SucklessTerminal = NovProgram()
SucklessTerminal.program_name = 'SucklessTerminal'
SucklessTerminal.category = 'System'
SucklessTerminal.arch_zsh_cmds = ['git clone https://github.com/LukeSmithxyz/st.git ~/Downloads/st',
                                  'patch -d ~/Downloads/st < ~/Files/GitHub_noSync/ArchLabs/MyDotFiles/.config/st/patch_from_lukes_to_my_st.diff',
                                  'make -C ~/Downloads/st',
                                  'sudo make install -C ~/Downloads/st'
                                  ]
SucklessTerminal.description = ""
SucklessTerminal.auto_install = True
vsi_programi.append(SucklessTerminal)
# Terminator ##################################################
